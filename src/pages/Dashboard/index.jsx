...
import {
  DASHBOARD_HOURLY_DATA,
  DASHBOARD_WEEKLY_DATA,
  DASHBOARD_MONTH_DAILY_DATA,
  DASHBOARD_PROJECTS_DATA,
  DASHBOARD_PIE_DATA,
  DASHBOARD_RECENT_ACTIVITY,
  DASHBOARD_STREAK,
  DASHBOARD_STREAK_THRESHOLDS
...
export default function Dashboard() {
  ...
  const activeColor = DASHBOARD_STREAK_THRESHOLDS.find(t => DASHBOARD_STREAK <= t.limit)?.color || "bg-primaryOrange";
    ...
    switch (timeRange) {
      case 'semana':
        return {
          ...
          chartData1: DASHBOARD_WEEKLY_DATA,
          chartData2: DASHBOARD_WEEKLY_DATA
        };
      case 'mês':
        return {
          pomodoros: '180/200',
          ...
          chartData1: DASHBOARD_MONTH_DAILY_DATA,
          chartData2: DASHBOARD_MONTH_DAILY_DATA
        };
      default:
        return {
          pomodoros: '12/16',
          ...
          chartData1: DASHBOARD_HOURLY_DATA,
          chartData2: DASHBOARD_HOURLY_DATA
        };
    }
  };
      ...
      <div className="flex-1 gap-4 md:gap-8 flex flex-col">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-8 ">
          ...
          <div className="flex border-white/15 rounded-lg border p-3 sm:p-5 items-center gap-1 md:gap-0 flex-col justify-between">
            <div className="ml-0 md:ml-6 md:mr-6  truncate w-full flex flex-col gap-2 ">
              <div className="flex justify-between">
                <p className="text-white text-base md:text-xl  font-bold truncate w-full">{DASHBOARD_STREAK} dias</p>
              ...
              <div className="flex gap-1">
                {[...Array(8)].map((_, i) => {
                  return (
                    <div
                      key={i}
                      className={`h-3.5 w-3.5 rounded-sm ${i < DASHBOARD_STREAK ? activeColor : 'bg-white/10'}`}
                    />
                  );
                })}
              </div>
        ...
        <div className="flex flex-col md:flex-row w-full gap-4 md:gap-6 justify-between">
          <div className='w-full md:w-[65%] border-white/10 rounded-xl border p-6 flex flex-col'>
            ...
            <div className="flex flex-col gap-6 flex-1">
              {DASHBOARD_PROJECTS_DATA.map((project) => (
          ...
          <div className='w-full md:w-[33%] border-white/10 rounded-xl border p-6 flex flex-col'>
            ...
            <div className="flex-1 flex flex-col items-center justify-center min-h-[220px]">
              {chartsReady ? (
                <ResponsiveContainer width="100%" height={220}>
                  <PieChart>
                    <Pie
                      ...
                      stroke="none"
                    >
                      {DASHBOARD_PIE_DATA.map((entry, index) => (
                ...
                <Skeleton className="w-[200px] h-[200px] rounded-full bg-white/5" />
              )}
            </div>

            <div className="mt-4 flex flex-col gap-3">
              {DASHBOARD_PIE_DATA.slice(0, 4).map((entry) => (
        ...
        <div className="flex-shrink-0 border-white/10 rounded-xl border p-6 mb-8 w-full overflow-hidden flex flex-col h-auto">
          ...
          <div className="flex flex-col flex-1 justify-center">
            {DASHBOARD_RECENT_ACTIVITY.map((activity) => (
