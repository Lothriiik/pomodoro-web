          ...
          <div className='w-[70%]'>
            <div className='h-[30%] mb-2'>
              <p className="text-white font-medium truncate">
                Resumo - {weekDays.find(d => d.key === selectedDay)?.label} {weekDays.find(d => d.key === selectedDay)?.displayDate}
              </p>
            </div>
            <div className='flex justify-between gap-2 w-full'>
              <div className='flex-1 flex flex-col items-center min-w-0'>
                <p className="text-white font-bold text-lg tracking-tight truncate w-full text-center">20h 20m</p>
                <p className="text-gray-400 text-xs tracking-tight truncate w-full text-center">Tempo Focado</p>
              </div>

              <div className='flex-1 flex flex-col items-center min-w-0 border-x border-white/5'>
                <p className="text-white font-bold text-lg tracking-tight truncate w-full text-center">5 / 20</p>
                <p className="text-gray-400 text-xs tracking-tight truncate w-full text-center">Atividades Concluidas</p>
              </div>
            </div>
          </div>
