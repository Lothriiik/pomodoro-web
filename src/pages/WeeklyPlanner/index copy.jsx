...
const MOCK_DATA = {
  ...
  sex: [{ id: 6, time: "19:00", title: "Projeto", tag: "Freelance", cycles: 4, color: "blue" }],
  sab: [],
  dom: []
};
  ...
  return (
    <div className="flex flex-col h-screen gap-6">
      ...
      <div className='flex flex-row w-full h-[20vh] justify-between'>
        <div className="h-full w-[30vw] border-white/15 rounded-lg border p-4 bg-white/[0.02]">
          <h3 className="text-white">Agendar Tarefa para {weekDays.find(d => d.key === selectedDay)?.label}</h3>
        </div>

        <div className="h-full w-[60vw] border-white/15 rounded-lg border p-4 bg-white/[0.02]">
